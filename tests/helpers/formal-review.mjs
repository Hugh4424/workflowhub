...
export function writeFormalReviewFixture({ task, stage, snapshotTree, reviewTrack = null, verdict = "pass", provider = "fixture-provider" } = {}) {
  ...
  writer.writeAttempt(attemptRef, {
    ...
    review_track: reviewTrack, source, snapshot_tree: snapshotTree, material_id: materialId,
