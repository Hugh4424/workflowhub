...
export function writeFormalReviewFixture({ task, stage, snapshotTree, reviewTrack = null, verdict = "pass", provider = "fixture-provider", subjectKind = "worktree", phaseId = null } = {}) {
  ...
  const subject = { subject_kind: subjectKind, phase_id: phaseId, base_tree: snapshotTree, candidate_tree: snapshotTree };
