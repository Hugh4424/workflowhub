  ...
  it("covers the mixed v1/v2/availability/historical/malformed input contract", () => {
    ...
    try {
      ...
      writeJson(join(v2TaskRoot, "quality/stage-reflection/build-plan.json"), {
        ...
        identity: { task_id: "task-v2", worktree: "/tmp/workflowhub", branch: "task/v2", attempt: "attempt-v2", snapshot_tree: "d".repeat(40), material_revision: `revision-${"c".repeat(64)}` },
        executor: { source_id: "fixture/reflection-executor", attempt_id: "attempt-v2", started_at: "2026-08-30T12:00:01.000Z", completed_at: "2026-08-30T12:00:02.000Z", output_hash: "a".repeat(64) },
