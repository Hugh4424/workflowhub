...
const cases = [
  ...
  ["AC-022", "review verdict is not a progression gate", "workflows/build-code/SKILL.md", "verdict is not a progression gate", "tests/stage-review-cost-policy.test.mjs", "keeps review as quality evidence, not work permission"],
