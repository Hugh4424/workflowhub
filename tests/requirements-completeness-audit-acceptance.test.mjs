...
const cases = [
  ...
  ["AC-010", "review failure provenance is preserved", "skills/wh-review/scripts/review-runner.mjs", "attempt", "skills/wh-review/scripts/__tests__/review-runner.test.mjs", "keeps transport failures separate from semantic review facts"],
  ...
  ["AC-018", "public review protocol failures are classified", "skills/wh-review/scripts/review-provider-client.mjs", "PUBLIC_RESULT_INVALID", "skills/wh-review/scripts/__tests__/review-provider-client-v3.test.mjs", "client preserves a broker public error instead of flattening it into protocol mismatch"],
  ...
  ["AC-024", "scope revision public input is removed", "skills/wh-review/scripts/wh-review-cli.mjs", "runSimpleReview(input)", "skills/wh-review/scripts/__tests__/wh-review-cli.test.mjs", "ignores the removed scope revision public input"],
  ...
  ["AC-027", "build-plan keeps production implementation separate from verification authoring", "workflows/build-plan/SKILL.md", "Do not implement production code or claim GREEN here", "tests/contract/post-cohort-executable-authoring.test.mjs", "makes build-plan author the real test/target RED owner"],
