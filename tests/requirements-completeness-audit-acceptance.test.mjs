...
const cases = [
  ...
  ["AC-003", "all original sources are replayed", "runtime/stage/stage-handlers.mjs", "function requirementReplayFacts", "tests/verify-requirement-replay-contract.test.mjs", "requires the semantic reverse check while keeping replay storage optional"],
  ...
  ["AC-027", "build-plan writes a complete test strategy", "skills/spec-tasks/templates/tasks-template.md", "test_strategy", "tests/contract/spec-stage-artifact-closure.test.mjs", "test_strategy_owner"],
  ["AC-028", "build-code executes the recorded strategy", "workflows/build-code/steps.json", "test_strategy", "tests/contract/build-code-apply-contract.test.mjs", "predesigned"],
  ["AC-029", "restored content skills have auditable provenance", historicalDecisionLog, "c3e1b1c5b29e5c0aa35beca7718787b4c7a95faf", "tests/contract/spec-stage-artifact-closure.test.mjs", "retains the high-value template fields without creating a second authority"],
  ...
  ["AC-031", "missing semantic evidence stays incomplete", "runtime/stage/stage-handlers.mjs", "semantic proof is incomplete", "tests/verify-requirement-replay-contract.test.mjs", "requires the semantic reverse check while keeping replay storage optional"],
];
