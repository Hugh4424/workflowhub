...
timeout 30 agent-browser --session "$BROWSER_QA_SESSION" screenshot body "$manifest_dir/m16-monitor-390x844.png" >/dev/null 2>&1 || narrow_viewport_status=$?
...
timeout 30 agent-browser --session "$BROWSER_QA_SESSION" screenshot body "$manifest_dir/m16-monitor-1280x800.png" >/dev/null 2>&1 || wide_viewport_status=$?
