...
- [ ] T005 [FR-BASE-001,FR-BASE-002,FR-BASE-003,FR-BASE-004] 维护知识文件
...
### Tasks
- [ ] T006 [FR-COLL-001] 创建metrics-writer.mjs
...
- [ ] T007 [FR-COLL-001,FR-COLL-002] 集成smoke测试
...
- [ ] T008 [FR-COLL-001,FR-COLL-002] 维护知识文件
...
### Tasks
- [ ] T009 [FR-MAP-001,FR-MAP-002] 生成字段映射样例
...
### Tasks
- [ ] T013 [FR-FREEZE-001,FR-FREEZE-002] 写freeze-and-retire.md
...
- [ ] T014 [FR-MIG-001,FR-MIG-002,FR-MIG-003] 写migration-and-fallback.md
...
- [ ] T015 [FR-FREEZE-001,FR-FREEZE-002,FR-MIG-001,FR-MIG-002,FR-MIG-003] 维护知识文件
...
- [ ] T018 [FR-BASE-004,FR-COLL-002] 终验:baseline.mjs+host-adapter.mjs hash不变
  - 入参：baseline.mjs, host-adapter.mjs
  - 出参：hash对比确认
  - 文件：无新增
  - 验证：`git diff --name-only` 不含 metrics/baseline.mjs 和 metrics/adapters/host-adapter.mjs

- [ ] T019 [FR-CI-001,FR-CI-002,FR-BASE-004,FR-COLL-002] 维护知识文件+终验报告
