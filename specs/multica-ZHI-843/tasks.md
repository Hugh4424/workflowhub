...
- [ ] T005 [runner] 修改 `core/runner-identity.mjs`/`core/task-recovery.mjs`：clean real Git top-level、exact branch/HEAD/AGENTS/Skill、old OID ancestor、manifest/new identity、accepted business snapshot validation。  
