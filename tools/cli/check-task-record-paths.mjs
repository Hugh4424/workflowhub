...
const DIRECT_WRITER_AUTHORITIES = new Map([
  ...
  ["tools/cli/migrate-task-v2.mjs", "one-shot journaled legacy migration authority"],
  ...
  ["tools/cli/task-migrate-target-repo.mjs", "official target repository migration launcher"],
