...
const CAPABILITY_AUTHORITIES = new Map([
  ...
  ["runtime/stage/stage-runner.mjs", new Set(["caller-supplied storage/task path capability", "cwd identity discovery"])],
  ["runtime/stage/stage-reflect.mjs", new Set(["caller-supplied storage/task path capability"])],
  ["tools/cli/append-lesson-observation.mjs", new Set(["caller-supplied storage/task path capability"])],
  ["tools/cli/validate-stage-reflection.mjs", new Set(["caller-supplied storage/task path capability"])],
...
const DIRECT_WRITER_AUTHORITIES = new Map([
  ...
  ["runtime/stage/stage-reflect.mjs", "stage-reflection lesson transaction authority"],
  ...
  ["tools/cli/validate-stage-reflection.mjs", "deterministic stage-reflection validation authority"],
  ["skills/wh-review/scripts/review-runner.mjs", "trusted attachment review orchestration"],
  ...
  ["scripts/constitution-mapping-check.mjs", "development checker fixture"],
  ["scripts/dead-code-scan.mjs", "development checker fixture"],
  ["scripts/dual-track-evaluate.mjs", "development checker fixture"],
...
const GLOBAL_IDENTITY_DISCOVERY_ALLOWLIST = new Map([
  ...
  ["tools/cli/smoke-local-skill-dispatch.mjs", "registered direct package smoke entry"],
  ["skills/workflowhub-multica-sync/scripts/multica-skill-sync.mjs", "explicit Multica synchronization launcher"],
  ["runtime/stage/stage-runner.mjs", "authenticated TaskHandle-bound stage runner"],
]);
