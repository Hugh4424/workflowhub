 ...
 *
 * Anti-host-dependency lint for workflowhub production runtime files.
 * Scans runtime/*.mjs (via scanCoreFiles) for four classes of host coupling.
 *
 * Exit codes:
 ...
 *
 * CLI:
 *   node tools/cli/check-anti-host.mjs              # scan runtime/ (default)
 *   node tools/cli/check-anti-host.mjs --self-test  # prove all four regex classes fire
 *   node tools/cli/check-anti-host.mjs --files f1 f2 ...  # scan specific files (for tests)
 *   node tools/cli/check-anti-host.mjs --list-files # print files that would be scanned
 *
