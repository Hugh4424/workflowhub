...
3. Write `plan.md`: rationale, affected files, implementation order, and commit boundaries.
4. Write `tasks.md`: one entry per phase, each with Goal, Files, Tasks, and Verify steps.
