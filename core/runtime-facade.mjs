...
const BEHAVIOR_BY_INTERNAL_OPERATION = Object.freeze({
  prepare: "doctor",
  "verify-recovery": "doctor",
  "continue-stage": "status",
  "start-run": "status",
  "recover-run": "status",
  "invalidate-run": "status",
  "invalidate-step-attempt": "status",
  "invalidate-stage-attempt": "status",
  "invalidate-review-binding": "status",
  rebind: "status",
  reopen: "status",
  ...
  "publish-phase-trace-lineage": "verify",
  "supersede-phase-trace-lineage": "verify",
  "publish-acceptance-evidence": "verify",
  "publish-verify-failure": "verify",
  "publish-verify-passing": "verify",
  confirm: "confirm",
  accept: "authorize",
