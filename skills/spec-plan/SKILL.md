...
Receive frozen specification content, optional frozen
`spec-research-result.v1` content, and a controlled writer from build-plan. File
discovery, task identity, repository inference, and Git operations are outside
this component.
