...
| `AGH-BASE-10` | protocol 7: immutable numbered reports/index | removed (evidence) | V4 receipts are immutable per round, but report/index paths are replaceable projections, not AgentHub append-only numbered reports |
...
| `AGH-BASE-14` | protocol 11: precondition-fix label | removed (evidence) | no V4 schema, contract, validator, or disposition field persists this AgentHub-specific label |
