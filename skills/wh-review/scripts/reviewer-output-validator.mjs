...
const wholeArtifactAnchors = new Set(["changes.diff"]);
...
function concreteAnchor(value) { return concrete(value, 6) && (wholeArtifactAnchors.has(value) || /(?:[:#]|\bline\s*\d+\b|\bL\d+\b)/i.test(value)); }
