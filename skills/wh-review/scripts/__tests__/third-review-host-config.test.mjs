...
import { PACKET_SOURCE_PREFIX, loadTrustedThirdReviewConfig } from "../third-review-host-config.mjs";
...
function configuredRoot() {
  ...
  writeFileSync(brokerConfig, JSON.stringify({ version: 4, attachment_roots: [{ root: packetRoot, sources: [PACKET_SOURCE_PREFIX] }] }));
