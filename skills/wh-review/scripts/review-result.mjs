...
const FAILURE_CATEGORIES = Object.freeze({
  ...
  PROCESS_STALLED: "stalled",
  REVIEW_WAIT_EXCEEDED: "stalled",
  ...
  MATERIAL_TOO_LARGE: "input_too_large",
  REVIEW_INPUT_TOO_LARGE: "input_too_large",
  REVIEW_EXECUTION_TIMEOUT: "timeout",
